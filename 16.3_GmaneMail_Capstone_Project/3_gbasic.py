# This is just a downstream Data Analysis of database 'index.sqlite'.
import sqlite3
import time
import zlib
...
# Connect with the clean database 'index.sqlite'.
# We're retrieving the compressed 'headers' & 'body' here.
...
print('') # works like a new line character

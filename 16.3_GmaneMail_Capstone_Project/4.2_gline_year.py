...
for (message_id, message) in list(messages.items()):
    ...
    month = message[3][:4]
    ### Here only pull out from 0th to 3th, not inluding 4th.
    # Year is the first 4 characters of date (field 'sent_at'), eg. "2005-12".
...
print("Output written to gline_year.js")
